    ...
    return (
        <section className='section-bg section-common features-section pt-100 pb-70' data-aos="fade-up" data-aos-duration="2000">
            <div className="container">
                <SectionTitle subTitle="Why MyTeamUp?" title="Boost Revenue and Patient Satisfaction" description="We combine automation and real agents to help dental offices grow revenue, reduce no-shows, and save staff time."/>
